...
type UserConversationsShowRequest struct {
	PagingOptions postgres.PaginationOptions `json:"pagingOptions" query:"paging_options"`
	Filters       []postgres.Filter          `json:"filters" query:"filters"`
	Sorts         []postgres.Sort            `json:"sorts" query:"sorts"`
